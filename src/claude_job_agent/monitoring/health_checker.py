...
class HealthChecker:
        ...
        try:
            async with httpx.AsyncClient(timeout=10) as client:
                ...
                if response.status_code == 200:
                    ...
                    self.log_api_metric("adzuna", "search", response.status_code, response_time, 0, 0)
                    return {
                        "status": "unhealthy",
                        "response_time": response_time,
    ...
    def log_health_check(self, check_type: str, status: str, response_time: float, details: str):
